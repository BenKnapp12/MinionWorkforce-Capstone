...
var require_execa = __commonJS({
  "../../node_modules/.pnpm/execa@5.1.1/node_modules/execa/index.js"(exports2, module2) {
    ...
    module2.exports.sync = (file4, args, options) => {
      const parsed = handleArguments(file4, args, options);
      const command = joinCommand(file4, args);
      const escapedCommand = getEscapedCommand(file4, args);
...
async function resolveOrInstallPrismaClient(baseDir, version2) {
  ...
  try {
    await import_promises2.default.stat(import_node_path.default.join(projectRoot, "package.json"));
  } catch (err) {
    if (err.code === "ENOENT") {
      console.warn(
        yellow(
  ...
  prismaClientDir = await findPrismaClientDir(import_node_path.default.join(".", baseDir));
  if (!prismaClientDir) {
    throw new Error(
...
var PrismaClientJsGenerator = class {
  ...
  async #getPrismaClientPath(config) {
    ...
    this.#cachedPrismaClientPath = await this.#resolveOrInstallPrismaClient(import_node_path2.default.dirname(config.sourceFilePath));
    return this.#cachedPrismaClientPath;
  }
