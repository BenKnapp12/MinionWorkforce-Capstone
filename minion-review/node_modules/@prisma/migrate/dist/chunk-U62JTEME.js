...
var chunk_U62JTEME_exports = {};
__export(chunk_U62JTEME_exports, {
  DbExecute: () => DbExecute
});
module.exports = __toCommonJS(chunk_U62JTEME_exports);
...
See \`${(0, import_chunk_SKRR5WT4.green)((0, import_internals.getCommandWithExecutor)("prisma db execute -h"))}\``
    ...
    const migrate = await import_chunk_F3JIZWIS.Migrate.setup({ adapter });
    try {
